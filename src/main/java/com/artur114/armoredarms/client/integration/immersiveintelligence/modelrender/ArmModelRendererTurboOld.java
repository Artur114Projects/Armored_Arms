...
public class ArmModelRendererTurboOld implements IArmModelRenderer<ArmModelManagerArmor> {
    ...
    public ArmModelRendererTurboOld(ModelLightEngineerArmor model, IMultiTexture texture) {
