...
public class ArmModelRendererTurboNew implements IArmModelRenderer<ArmModelManagerArmor> {
    ...
    public ArmModelRendererTurboNew(ModelLightEngineerArmor model, IMultiTexture texture) {
        ...
        this.hand = new ModelRendererTurbo[][] {Reflector.getPrivateField(model, "leftArmModel"), Reflector.getPrivateField(model, "rightArmModel")};
    ...
    private void render(ModelRendererTurbo[] hand, ModelRendererTurbo[] plates, ItemStack stack) {
        ...
        NBTTagCompound upgrades = IIContent.itemLightEngineerChestplate.getUpgrades(stack);
