...
@Immutable
public class ArmModelRendererBiped implements IArmModelRendererBase<ArmModelManagerBiped> {
    ...
    public ArmModelRendererBiped(ModelBiped mb, IMultiTexture texture) {
        this.arms = new ModelRenderer[] {mb.bipedLeftArm, mb.bipedRightArm};
        this.texture = texture;
        this.mb = mb;
    }

    public ArmModelRendererBiped(ModelBiped mb, IMultiTexture texture, ModelRenderer right, ModelRenderer left) {
    ...
    @Override
    public void renderArm(ArmModelManagerBiped context, EnumHandSideAA side) {
