...
public class RenderArmManagerL {
    ...
    public void renderArm(AbstractClientPlayer player, EnumHandSide handSide) {
        ...
        this.render(playerArms[0], playerTex, IOverriderRender.EnumRenderType.ARM);
        this.render(playerArms[1], playerTex, IOverriderRender.EnumRenderType.ARM_WEAR);
        this.render(armorArm, armorTexOv, IOverriderRender.EnumRenderType.ARMOR_OVERLAY);
        this.render(armorArm, armorTex, IOverriderRender.EnumRenderType.ARMOR);

        this.render(armorArm, ENCHANTED_ITEM_GLINT_RES, IOverriderRender.EnumRenderType.ARMOR_ENCHANT);
    }

    public void render(ModelRenderer hand, ResourceLocation tex, IOverriderRender.EnumRenderType type) {
